...
public class Contrato {
    ...
    public String getFirmaUsuario() { return firmaUsuario; }
    public void setFirmaUsuario(String firmaUsuario) { this.firmaUsuario = firmaUsuario; }

    public Date getFechaFirmaUsuario() { return fechaFirmaUsuario; }
    public void setFechaFirmaUsuario(Date fechaFirmaUsuario) { this.fechaFirmaUsuario = fechaFirmaUsuario; }

    public String getIpUsuario() { return ipUsuario; }
    public void setIpUsuario(String ipUsuario) { this.ipUsuario = ipUsuario; }

    public String getFirmaAsistente() { return firmaAsistente; }
    public void setFirmaAsistente(String firmaAsistente) { this.firmaAsistente = firmaAsistente; }

    public Date getFechaFirmaAsistente() { return fechaFirmaAsistente; }
    public void setFechaFirmaAsistente(Date fechaFirmaAsistente) { this.fechaFirmaAsistente = fechaFirmaAsistente; }

    public String getIpAsistente() { return ipAsistente; }
    public void setIpAsistente(String ipAsistente) { this.ipAsistente = ipAsistente; }
